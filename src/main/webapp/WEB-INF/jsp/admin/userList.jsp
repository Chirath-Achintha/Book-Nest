...
<head>
    ...
    <title>User List - BookNest Admin</title>
...
<body class="admin-page">
    ...
    <div class="page-header">
        <div class="main-content">
            ...
            <p class="page-subtitle">View all registered users</p>
        </div>
    </div>
        ...
        <c:choose>
                                    ...
                                    <td>
                                        <div class="user-info">
                                            <div class="user-avatar">
                                                ${fn:toUpperCase(user.username.charAt(0))}
                                            </div>
            ...
            <c:otherwise>
                <div class="empty-state">
                    ...
                    <p class="empty-subtitle">No registered users in the system.</p>
                    <a href="<c:url value='/admin/users/add'/>" class="btn-add">
